...
// footer search box
$horizontal_alignment = blocksy_akg( 'footer_search_box_horizontal_alignment', $atts, 'flex-start' );
...
$vertical_alignment = blocksy_akg( 'footer_search_box_vertical_alignment', $atts, 'CT_CSS_SKIP_RULE' );
