...
$horizontal_alignment = blocksy_akg( 'footer_ls_horizontal_alignment', $atts, 'flex-start' );
...
$vertical_alignment = blocksy_akg( 'footer_ls_vertical_alignment', $atts, 'CT_CSS_SKIP_RULE' );
