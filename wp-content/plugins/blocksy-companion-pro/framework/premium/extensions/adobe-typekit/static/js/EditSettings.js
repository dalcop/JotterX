				...
				render={() => (
					<Fragment>
						<div className="ct-modal-content">
							<h2>{__('Typekit Fonts Settings', 'blc')}</h2>
							
							<p
								dangerouslySetInnerHTML={{
									__html: sprintf(
										__(
											'You can find %shere%s your Typekit Project ID. Once you insert your Project ID and click the "Fetch fonts" button, your fonts will become available in all theme’s typography options.',
											'blc'
										),
