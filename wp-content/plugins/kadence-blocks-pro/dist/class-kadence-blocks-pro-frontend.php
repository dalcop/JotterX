...
class Kadence_Blocks_Pro_Frontend {
	...
	public function blocks_modal_array( $attr, $unique_id ) {
		...
		if ( isset( $attr['closeHoverColor'] ) || isset( $attr['closeHoverBackground'] ) ) {
			$css .= '#kt-modal' . $unique_id . ' .kt-modal-close:hover, #kt-target-modal' . $unique_id . ' .kt-modal-close:hover, .kb-modal-content' . $unique_id . ' .kt-modal-close:hover, #kt-modal' . $unique_id . ' .kt-modal-close:focus, #kt-target-modal' . $unique_id . ' .kt-modal-close:focus, .kb-modal-content' . $unique_id . ' .kt-modal-close:focus {';
			$css .= 'outline: none;';
	...
	public function blocks_image_overlay_array( $attr, $unique_id ) {
		...
		if ( isset( $attr['overlayHoverOpacity'] ) && is_numeric( $attr['overlayHoverOpacity'] ) ) {
			$css .= '.kt-img-overlay' . $unique_id . ' .kt-image-overlay-wrap:hover:hover .kt-image-overlay-color-wrapper {';
