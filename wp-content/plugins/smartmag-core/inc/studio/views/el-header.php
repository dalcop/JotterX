...
<div class="elementor-templates-modal__header ts-el-studio__header">
	...
	<div class="elementor-templates-modal__header__menu-area">
		...
		<div class="ts-el-studio__header__tab elementor-component-tab elementor-template-library-menu-item <# if (data.activeTab === 'pages') { #> elementor-active <# } #>" data-tab="pages">Homes & Pages</div>
	</div>
