...
class SmartMag_Core 
{
	...
	public function __construct()
	{
		...
		$loader = new Bunyad_Loader($namespaces);
	...
	{		
		...
		if (class_exists('\Elementor\Plugin') || did_action('elementor/loaded')) {
			$elementor = new \Bunyad\Elementor;
	...
	public function setup_blocks()
	{
		...
		add_filter('bunyad_elementor_widgets', function() use ($blocks) {
			return $blocks; 
		});
	...
	public function add_profile_fields($fields)
	{
		$fields = array_merge((array) $fields, [
			...
			'bunyad_twitter'   => esc_html__('Twitter URL', 'bunyad-admin'),
