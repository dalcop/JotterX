...
class PHP_Editor_Admin {
	...
	public function print_admin_js_template() {
		...
		echo '<textarea id="neve-advanced-hook-php-code" name="neve-advanced-hook-php-code" class="wp-editor-area">' . htmlentities( $value ) . '</textarea>'; //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		echo '</div>';
		echo '</script>';
	}
